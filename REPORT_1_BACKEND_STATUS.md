...
- Signup no longer accepts client role assignment to prevent privilege escalation.
...
- Add endpoint-level role policies where business rules require stricter access.
